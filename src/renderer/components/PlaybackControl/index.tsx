...
const PlaybackControl = () => {
  ...
  return (
    <footer className='app-fixed-chrome-surface window-no-drag bg-background/50 border-border/60 fixed right-0 bottom-0 left-0 z-50 border-t backdrop-blur-2xl'>
      <PlaybackProgressBar />
