  ...
  return (
    <div className='w-full max-w-[480px] space-y-3'>
      <Slider
        ...
        className='[&_[data-slot=slider-range]]:bg-[var(--player-foreground)] [&_[data-slot=slider-thumb]]:size-3.5 [&_[data-slot=slider-thumb]]:border-white/40 [&_[data-slot=slider-thumb]]:bg-[var(--player-foreground)] [&_[data-slot=slider-track]]:h-1.5 [&_[data-slot=slider-track]]:bg-white/18'
      />
